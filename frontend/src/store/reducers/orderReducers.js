...
export const myOrdersReducer = (state={ orders:[] },action) => {
    switch(action.type){
        case actionTypes.ORDER_MYORDERS_REQUEST : 
            return {loading:true}
        case actionTypes.ORDER_MYORDERS_SUCCESS :
            return {loading:false,orders:action.payload}
        case actionTypes.ORDER_MYORDERS_FAIL :
            return {loading:false,error:action.payload}
        case actionTypes.ORDER_MYORDERS_RESET :
            return {orders:[]}
        default :
            return state;
    }
